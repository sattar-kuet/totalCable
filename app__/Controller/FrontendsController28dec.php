...
class FrontendsController extends AppController {
    ...
    public function beforeFilter() {
        ...
        //  $this->Auth->allow('*');
        $this->Auth->allow(array('index', 'fileUpload', 'techregistration', 'shipping_and_returns', 'packagesignup', 'customerSignup', 'troubleshoot', 'tariffplan', 'whytotalcable', 'contactus', 'newses', 'reseller', 'shipping', 'package', 'terms_and_conditions', 'refer', 'channels', 'registration', 'musical_night', 'seat_booking', 'area_channels', 'hazaro_konthe_sonar_bangla'));
...
//                exit;
    ...
    function customerSignup() {
        ...
        if ($this->request->is('post')) {
            ...
            $submitted_by = $this->request->data['Customer']['submitted_by'];
            ...
            $mail_content = __('Name:                      ', 'beopen') . $cus_name . PHP_EOL .
                            ...
                            __('Sale status:               ', 'beopen') . $sale_status . PHP_EOL .
                            __('Note:                      ', 'beopen') . $note . PHP_EOL .
                            __('Submitted by:              ', 'beopen') . $submitted_by . PHP_EOL;                                                
            sendEmail($from, $cus_name, $to, $subject, $mail_content);
            // End send mail 
   ...
   <strong>Your registration Completed succeesfully </strong>
    ...
    function fileUpload() {
        ...
        if ($this->request->is('post')) {
            ...
            $to = array('sakibbd@ymail.com', 'sales@totaltvs.org', 'totaltvs.nihad@gmail.com', 'totaltvs.raisul@gmail.com', 'saleh.totaltvs@gmail.com', 'sattar.kuet@gmail.com'); 
