...
<!--                    <li>
                    ...
                    <li>
                       <a href="<?php echo Router::url(array('controller' => 'Frontends', 'action' => 'service_order_form_new')) ?>"><span class="icon16 icomoon-icon-list-view-2"></span>Customer Reg. form</a> 
                    </li>
                    <li>
                       <a href="<?php echo Router::url(array('controller' => 'users', 'action' => 'achievement')) ?>"><span class="icon16 icomoon-icon-list-view-2"></span>Achievement</a> 
                    </li>
