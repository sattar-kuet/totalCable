                    ...
                    <div class="navbar">
                        <div class="navbar-inner">
                            <div class="container">
                                ...
                                <a  class="site-logo" href="<?php echo Router::url(array('controller' => '/', 'action' => 'index')) ?>"><img src="<?php echo $this->webroot; ?>assets/frontend/layout/img/logos/logo-corp-red.png" alt="Total Cable USA" title="Total Cable USA"></a>
                            </div>
                        </div><!-- /navbar-inner -->
                    </div><!-- /navbar -->
