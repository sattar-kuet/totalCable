        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="container">
                ...
                <div class="header-navigation pull-right font-transform-inherit">
                       <iframe width="560" height="315" src="https://www.youtube.com/embed/smkVumokWXE" frameborder="0" allowfullscreen></iframe>
                ...
                <div class="header-navigation pull-right font-transform-inherit">
                    <ul>
                       ...
                       <li><a href="<?php echo Router::url(array('action' => 'hazaro_konthe_sonar_bangla')) ?>" >Hazaro Khonthe Sonar Bangla</a></li>
