                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group" style="margin-left: 0px;">
                                                        ...
                                                        <div class="radio-list">
                                                            <label style="padding-top: 0px;" class="radio-inline"><input type="radio" name="optradio">VISA</label>
                                                            <label style="padding-top: 0px;" class="radio-inline"><input type="radio" name="optradio">MASTER Card </label>
