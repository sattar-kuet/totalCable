                        ...
                        <div class="seperate">
                            ...
                            <div class="seatplan_row">
                                <div class="l" style="list-style:none;">
                                    <div class="quater">
                                        <?php
                                        $levels_mid = array('Z', 'Y', 'X', 'W', 'V', 'U', 'T', 'S', 'R', 'Q', 'P', 'O');
                                    ...
                                    <div class="quater sep-txt">
                                        ...
                                        <div class="quater-half">
                                            <div class=" seattext" title="This seat is <?php echo status($status, $seatNo); ?>"><?php //echo $seat;        ?>Y
                                            </div>
                                        </div>
                                        <div class="quater-half">
                        ...
                        <div class="seperate">
                            ...
                            <div class="seatplan_row">
                                <div class="l" style="list-style:none;">
                                    <div class="quater">
                                        <?php
                                        $levels_bottom = array('N', 'M', 'L', 'K','H', 'J', 'G', 'F', 'E', 'D', 'C', 'B', 'A', 'EE', 'DD', 'CC');
                                    ...
                                    <div class="quater">
                                        ...
                                        <div class="quater-half">
                                            <div class="  seattext" title="This seat is <?php echo status($status, $seatNo); ?>"><?php //echo $seat;        ?>H
                                            </div>
                                        </div>
                                        <div class="quater-half">
