                                    ...
                                    <tr>
                                        <td class="signupfont">
                                            <div class="form-group" style="margin-left: 0px;">
                                                <div class="">
                                                    <label><input id="sig1" type="radio" name="optradio">CARD (DEBIT/CREDIT)</label>
                                                </div>
                                                <div class="">
                                                    <label><input id="sig2" type="radio" name="optradio">PERSONAL CHECK</label>
                                                </div>
                                                <div class="">
                                                    <label><input id="sig2" type="radio" name="optradio">CERTIFIED CHECK</label>
                                                </div>
                                                <div class="">
                                                    <label><input id="sig2" type="radio" name="optradio">MONEY ORDER</label>
                                                </div>
